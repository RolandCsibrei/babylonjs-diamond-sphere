...
module.exports = configure(function(/* ctx */) {
  return {
    ...
    animations: ['slideInUp', 'slideInDown', 'slideOutDown', 'fadeIn', 'fadeOut', 'flip', 'heartBeat'],
    ...
    pwa: {
      ...
      manifest: {
        name: 'BabylonJS Diamond shaders by Roland Csibrei (c) 2021',
        short_name: 'BabylonJS Diamond shaders',
